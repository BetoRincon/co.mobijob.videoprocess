...
class CoMobijobVideoprocessModule : public titanium::Proxy
{
public:
	explicit CoMobijobVideoprocessModule();
...
private:
	...
	static void resizeVideo(const v8::FunctionCallbackInfo<v8::Value>&);
